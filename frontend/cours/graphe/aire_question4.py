...
aire = 2
plt.text(0.02, 0.98, f'$A = {aire}$', 
         transform=plt.gca().transAxes, fontsize=14, fontweight='bold',
         bbox=dict(boxstyle='round', facecolor='lightgreen', alpha=0.8),
         verticalalignment='top')

# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/aire_question4.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'aire_question4.png' créé avec succès!")
