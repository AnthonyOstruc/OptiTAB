...
ELEVENLABS_APPLY_TEXT_NORMALIZATION = os.getenv('ELEVENLABS_APPLY_TEXT_NORMALIZATION', 'on').strip()
...
ELEVENLABS_VOICE_STABILITY = _float_env('ELEVENLABS_VOICE_STABILITY', 0.64)
ELEVENLABS_VOICE_SIMILARITY_BOOST = _float_env('ELEVENLABS_VOICE_SIMILARITY_BOOST', 0.84)
ELEVENLABS_VOICE_STYLE = _float_env('ELEVENLABS_VOICE_STYLE', 0.10)
ELEVENLABS_VOICE_SPEED = _float_env('ELEVENLABS_VOICE_SPEED', 1.0)
