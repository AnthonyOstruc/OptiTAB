...
# Courbes
plt.plot(x1, f(x1), 'b-', linewidth=2, label=r'$f(x) = \sin(x)$')
...
plt.axvline(x=b, color='red', linestyle='--', linewidth=1.5, alpha=0.7, label='$x = \pi$')
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/valeur_moyenne_question2.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'valeur_moyenne_question2.png' créé avec succès!")
