...
# Courbe
plt.plot(x, m(x), 'b-', linewidth=2, label=r'$m(x) = \frac{x^2 - 4}{x^2 + 1}$')

# Asymptote horizontale y = 1
plt.axhline(y=1, color='green', linestyle='--', linewidth=1.5, alpha=0.7, label='Asymptote horizontale $y = 1$')
...
# Point clé (point où la courbe coupe l'axe y)
ax.plot(0, m(0), 'ro', markersize=6)
ax.annotate('(0, -4)', (0, m(0)), xytext=(1.5, m(0)-1), fontsize=10)
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/asymptotes_question5.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'asymptotes_question5.png' créé avec succès!")
