...
x1 = np.linspace(-20, 0.95, 1500)
x2 = np.linspace(1.05, 20, 1500)

# Courbes
plt.plot(x1, a(x1), 'b-', linewidth=2, label=r'$a(x) = \frac{1}{x - 1}$')
plt.plot(x2, a(x2), 'b-', linewidth=2)
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/discontinuites_question1.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'discontinuites_question1.png' créé avec succès!")
