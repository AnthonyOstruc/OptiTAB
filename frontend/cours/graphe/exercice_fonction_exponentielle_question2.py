...
# Point minimum de f(x) en x = ln(3/2)
x_critique = np.log(3/2)
plt.plot(x_critique, f(x_critique), 'go', markersize=6, label=f'Minimum en $x = \\ln(\\frac{{3}}{{2}})$')
...
# Sauvegarde
plt.savefig('exercice_fonction_exponentielle_question2.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'exercice_fonction_exponentielle_question2.png' créé avec succès!")
