...
class AIConversation(BaseContent):
    ...
    contexte_notion = models.ForeignKey('curriculum.Notion', on_delete=models.SET_NULL, null=True, blank=True, related_name='ai_conversations')
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['contexte_notion']),
        ]
