...
plt.plot(x1, f2(x1), 'r-', linewidth=2, label=r'$y = 4x - x^2$')
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/applications_geometriques_question2.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'applications_geometriques_question2.png' créé avec succès!")
