...
x_min = np.log(3/2)
y_min = f(x_min)  # = -1/4
plt.plot(x_min, y_min, 'ro', markersize=8, label=f'Minimum = -1/4')

# Solutions f(x) = 0 : x = 0 et x = ln(2)
plt.plot(0, f(0), 'go', markersize=8)
plt.plot(np.log(2), f(np.log(2)), 'go', markersize=8, label='Solutions f(x) = 0')
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/etude_exponentielle_question1.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'etude_exponentielle_question1.png' créé avec succès!")
