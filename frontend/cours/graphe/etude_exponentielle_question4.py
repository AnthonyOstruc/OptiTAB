...
# Tracer la courbe
plt.plot(x, y, 'b-', linewidth=2, label=r'$k(x) = x^2e^{-x}$')

# Point remarquable : maximum en x = 2
x_max = 2
y_max = k(x_max)  # = 4/e^2
plt.plot(x_max, y_max, 'ro', markersize=8, label=f'Maximum = 4/e²')

# Points aux bornes
plt.plot(0, k(0), 'go', markersize=8, label='k(0) = 0')
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/etude_exponentielle_question4.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'etude_exponentielle_question4.png' créé avec succès!")
