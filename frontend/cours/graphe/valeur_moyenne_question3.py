...
plt.text(0.02, 0.98, f'$\\mu = e - 1 \\approx {valeur_moyenne:.3f}$', 
         transform=plt.gca().transAxes, fontsize=14, fontweight='bold',
         bbox=dict(boxstyle='round', facecolor='lightblue', alpha=0.8),
         verticalalignment='top')

# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/valeur_moyenne_question3.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'valeur_moyenne_question3.png' créé avec succès!")
