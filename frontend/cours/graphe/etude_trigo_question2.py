...
plt.plot(x, f(x), 'b-', linewidth=1.5, label=r'$g(x) = \sin^2(x) - \cos^2(x)$')
...
plt.plot(max_x1, f(max_x1), 'go', markersize=6, markeredgecolor='darkgreen', markeredgewidth=1, label='Max en $\\frac{\\pi}{2}, \\frac{3\\pi}{2}$')
plt.plot(max_x2, f(max_x2), 'go', markersize=6, markeredgecolor='darkgreen', markeredgewidth=1)
plt.plot(min_x1, f(min_x1), 'ro', markersize=6, markeredgecolor='darkred', markeredgewidth=1, label='Min en $0, \\pi, 2\\pi$')
plt.plot(min_x2, f(min_x2), 'ro', markersize=6, markeredgecolor='darkred', markeredgewidth=1)
plt.plot(min_x3, f(min_x3), 'ro', markersize=6, markeredgecolor='darkred', markeredgewidth=1)
...
ax.text(-0.3, -1.5, '0', fontsize=10, ha='center', va='top')
...
for x_val, label in xticks_pi:
    ...
    ax.text(x_val, -1.5, label, ha='center', va='top', fontsize=10)
...
# Sauvegarder
plt.savefig('etude_trigo_question2.png', dpi=300, bbox_inches='tight')
print("Graphique 'etude_trigo_question2.png' créé avec succès!")
