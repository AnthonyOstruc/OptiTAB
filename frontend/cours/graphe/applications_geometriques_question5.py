...
# Courbes
plt.plot(x1, f1(x1), 'b-', linewidth=2, label=r'$y = x^4 - 2x^2$')
plt.plot(x1, f2(x1), 'r-', linewidth=2, label=r'$y = 2x^2$')

# Remplissage de l'aire entre les courbes - Partie 1 (-2 à 0)
...
# Remplissage de l'aire entre les courbes - Partie 2 (0 à 2)
...
plt.axvline(x=a, color='red', linestyle='--', linewidth=1.5, alpha=0.7, label='$x = -2$')
...
aire = 128/15
plt.text(0.02, 0.98, f'$A = \\frac{{128}}{{15}} \\approx {aire:.3f}$', 
         transform=plt.gca().transAxes, fontsize=14, fontweight='bold',
         bbox=dict(boxstyle='round', facecolor='lightgreen', alpha=0.8),
         verticalalignment='top')

# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/applications_geometriques_question5.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'applications_geometriques_question5.png' créé avec succès!")
