...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/valeur_moyenne_question1.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'valeur_moyenne_question1.png' créé avec succès!")
