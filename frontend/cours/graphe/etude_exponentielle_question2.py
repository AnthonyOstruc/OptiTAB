...
# Tracer la courbe
plt.plot(x, y, 'b-', linewidth=2, label=r'$g(x) = xe^x$')
...
# Point en x = 0
plt.plot(0, g(0), 'go', markersize=8, label='g(0) = 0')
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/etude_exponentielle_question2.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'etude_exponentielle_question2.png' créé avec succès!")
