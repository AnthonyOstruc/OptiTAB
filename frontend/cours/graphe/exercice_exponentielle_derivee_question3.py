...
# Point minimum de g(x) en x = -1
plt.plot(-1, g(-1), 'go', markersize=6, label='Minimum en $x = -1$')

# Asymptote horizontale y = 0
plt.axhline(y=0, color='orange', linestyle='--', linewidth=1.5, label='Asymptote $y = 0$ en $-\\infty$')
...
# Sauvegarde
plt.savefig('exercice_exponentielle_derivee_question2.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'exercice_exponentielle_derivee_question2.png' créé avec succès!")
