...
# Courbes
plt.plot(x1, f(x1), 'b-', linewidth=2, label=r'$f(x) = \sqrt{x}$')
...
aire = 16/3  # ≈ 5.33
plt.text(0.02, 0.98, f'$A = \\frac{{16}}{{3}} \\approx {aire:.3f}$', 
         transform=plt.gca().transAxes, fontsize=14, fontweight='bold',
         bbox=dict(boxstyle='round', facecolor='lightgreen', alpha=0.8),
         verticalalignment='top')

# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/aire_question3.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'aire_question3.png' créé avec succès!")
