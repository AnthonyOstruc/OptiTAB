...
# Courbe
plt.plot(x, f(x), 'b-', linewidth=2, label=r'$f(x) = e^{2x} - 4e^x + 3$')
...
plt.plot(np.log(3), 0, 'ro', markersize=6, label='Solution $x = \\ln(3)$')
...
# Sauvegarde
plt.savefig('exercice_exponentielle_equations_question3.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'exercice_exponentielle_equations_question3.png' créé avec succès!")
