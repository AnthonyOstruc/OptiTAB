...
# Annotation
ax.annotate('Limite = 1', (0, 1), xytext=(2, 2), fontsize=10,
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/continuite_question3.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'continuite_question3.png' créé avec succès!")
