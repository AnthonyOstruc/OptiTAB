...
# Courbes
plt.plot(x1, f1(x1), 'b-', linewidth=2, label=r'$y = e^x$')
plt.plot(x1, f2(x1), 'r-', linewidth=2, label=r'$y = 1$')
...
# Création du polygone pour l'aire entre les courbes
vertices = list(zip(x_fill, y1_fill)) + list(zip(x_fill[::-1], y2_fill[::-1]))
...
aire = np.e - 2
plt.text(0.02, 0.98, f'$A = e - 2 \\approx {aire:.3f}$', 
         transform=plt.gca().transAxes, fontsize=14, fontweight='bold',
         bbox=dict(boxstyle='round', facecolor='lightgreen', alpha=0.8),
         verticalalignment='top')

# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/aire_entre_courbes_question4.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'aire_entre_courbes_question4.png' créé avec succès!")
