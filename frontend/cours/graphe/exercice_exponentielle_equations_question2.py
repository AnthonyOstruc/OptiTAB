...
# Ligne horizontale y = 5
plt.axhline(y=5, color='red', linestyle='--', linewidth=2, label='$y = 5$')

# Point d'intersection (solution)
plt.plot(np.log(5), 5, 'go', markersize=6, label='Solution $x = \\ln(5)$')

# Annotation pour la solution
ax.annotate('Intersection en $x = \\ln(5)$', (np.log(5), 5), xytext=(10, 10), fontsize=10,
...
# Sauvegarde
plt.savefig('exercice_exponentielle_equations_question2.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'exercice_exponentielle_equations_question2.png' créé avec succès!")
