...
# Courbes
plt.plot(x1, h(x1), 'b-', linewidth=2, label=r'$h(x) = \frac{\sin x}{x}$')
plt.plot(x2, h(x2), 'b-', linewidth=2)

# Point de prolongement en x = 0, y = 1 (k = 1 pour continuité)
plt.plot(0, 1, 'go', markersize=8, label='Prolongement continu : $k = 1$')

# Annotation
ax.annotate('$h(0) = k = 1$', (0, 1), xytext=(-6, 4), fontsize=10,
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/applications_continuite_question5.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'applications_continuite_question5.png' créé avec succès!")
