...
y1 = x1**2
plt.plot(x1, y1, 'b-', linewidth=2, label=r'$g(x)$ (fonction par morceaux)')

# Deuxième partie: 2x - 1 pour x ≥ 1
y2 = 2*x2 - 1
plt.plot(x2, y2, 'b-', linewidth=2)

# Point de jonction en x = 1, y = 1 (continue)
plt.plot(1, 1, 'go', markersize=8, label='Point de continuité $(1, 1)$')

# Annotation
ax.annotate('Continue en $x=1$', (1, 1), xytext=(3, 3), fontsize=10,
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/continuite_question2.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'continuite_question2.png' créé avec succès!")
