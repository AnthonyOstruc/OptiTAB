...
# Points d'inflexion
plt.plot([-a, a], [f(-a), f(a)], 'go', markersize=8, label=r"Points d'inflexion $x = \pm\frac{\sqrt{2}}{2}$")
...
# Ajouter un sous-graphique avec zoom sur les points d'inflexion
...
ax_zoom.set_title('Zoom sur les points d\'inflexion', fontsize=8)
ax_zoom.tick_params(labelsize=6)

# Sauvegarde
plt.savefig('exercice_exponentielle_convexite_question3.png', dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'exercice_exponentielle_convexite_question3.png' créé avec succès!")
