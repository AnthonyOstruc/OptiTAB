...
# Domaine de définition (éviter x = -1)
x1 = np.linspace(-20, -1.05, 1500)
x2 = np.linspace(-0.95, 20, 1500)

# Courbes
plt.plot(x1, k(x1), 'b-', linewidth=2, label=r'$k(x) = \frac{x^2 + 2x}{x + 1}$')
...
plt.plot(x_asymptote, asymptote_oblique(x_asymptote), 'green', linestyle='--', linewidth=1.5, alpha=0.7, label='Asymptote oblique $y = x + 1$')
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/asymptotes_question4.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'asymptotes_question4.png' créé avec succès!")
