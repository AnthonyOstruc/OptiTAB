...
plt.axvline(x=b, color='red', linestyle='--', linewidth=1.5, alpha=0.7, label='$x = 3$')
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/aire_question1.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'aire_question1.png' créé avec succès!")
