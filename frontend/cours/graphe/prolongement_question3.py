...
# Courbes
plt.plot(x1, h(x1), 'b-', linewidth=2, label=r'$h(x) = \frac{\ln(1 + x)}{x}$')
...
plt.plot(0, 1, 'go', markersize=6, label='Prolongement : $h(0) = 1$')

# Annotation
ax.annotate('$h(0) = 1$', (0, 1), xytext=(-5, 4), fontsize=10,
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/prolongement_question3.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'prolongement_question3.png' créé avec succès!")
