...
plt.plot(0, 0, 'ro', markersize=6, label='Solution $x = 0$')
plt.plot(np.log(2), 0, 'ro', markersize=6, label='Solution $x = \\ln(2)$')
...
# Sauvegarde
plt.savefig('exercice_fonction_exponentielle_question4.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'exercice_fonction_exponentielle_question4.png' créé avec succès!")
