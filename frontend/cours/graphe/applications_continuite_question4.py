...
plt.plot(x, f2(x), 'r-', linewidth=2, label=r'$y = x + 2$')

# Point minimum de f(x) = e^x - x - 2 en x = 0
plt.plot(0, np.exp(0), 'go', markersize=6)
ax.annotate('Minimum en $x=0$', (0, np.exp(0)), xytext=(-6, 3), fontsize=10,
            arrowprops=dict(arrowstyle='->', color='green', lw=1))

# Annotation pour les 2 solutions
ax.text(0.5, 0.98, '2 solutions (une à gauche, une à droite de $x=0$)', 
        transform=ax.transAxes, fontsize=11, bbox=dict(boxstyle='round', 
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/applications_continuite_question4.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'applications_continuite_question4.png' créé avec succès!")
