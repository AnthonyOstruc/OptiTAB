...
# Tracer la fonction sinus hyperbolique
ax.plot(x, y, 'b-', linewidth=2, label='sh(x)')
...
for i, (px, py) in enumerate(zip(points_x, points_y)):
    ...
    ax.annotate('(0, 0)', (px, py), xytext=(px+0.5, py+0.5), fontsize=10)
...
# Sauvegarder
plt.savefig('graphe_sinus_hyperbolique.png', dpi=300, bbox_inches='tight')
plt.show()
