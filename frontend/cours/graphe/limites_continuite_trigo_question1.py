...
# Point limite en (0, 1) - prolongement par continuité
plt.plot(0, 1, 'go', markersize=8, markeredgecolor='darkgreen', markeredgewidth=2, label=r'$\lim_{x \to 0} \frac{\sin(x)}{x} = 1$', zorder=5)
...
# Sauvegarder
plt.savefig('limites_continuite_trigo_question1.png', dpi=300, bbox_inches='tight')
print("Graphique 'limites_continuite_trigo_question1.png' créé avec succès!")
