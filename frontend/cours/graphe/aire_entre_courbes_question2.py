...
# Courbes
plt.plot(x1, f1(x1), 'b-', linewidth=2, label=r'$y = x$')
plt.plot(x1, f2(x1), 'r-', linewidth=2, label=r'$y = x^2$')
...
aire = 1/6
plt.text(0.02, 0.98, f'$A = \\frac{{1}}{{6}} \\approx {aire:.3f}$', 
         transform=plt.gca().transAxes, fontsize=14, fontweight='bold',
         bbox=dict(boxstyle='round', facecolor='lightgreen', alpha=0.8),
         verticalalignment='top')

# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/aire_entre_courbes_question2.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'aire_entre_courbes_question2.png' créé avec succès!")
