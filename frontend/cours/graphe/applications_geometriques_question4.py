...
plt.plot(x1, f2(x1), 'r-', linewidth=2, label=r'$y = e^{-x}$')
...
aire = np.e + 1/np.e - 2
plt.text(0.02, 0.98, f'$A = e + \\frac{{1}}{{e}} - 2 \\approx {aire:.3f}$', 
         transform=plt.gca().transAxes, fontsize=14, fontweight='bold',
         bbox=dict(boxstyle='round', facecolor='lightgreen', alpha=0.8),
         verticalalignment='top')

# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/applications_geometriques_question4.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'applications_geometriques_question4.png' créé avec succès!")
