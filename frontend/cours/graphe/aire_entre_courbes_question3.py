...
# Remplissage de l'aire entre les courbes - Partie 2 (π/4 à π/2)
...
plt.axvline(x=b, color='red', linestyle='--', linewidth=1.5, alpha=0.7, label='$x = \pi/2$')
plt.axvline(x=intersection, color='orange', linestyle=':', linewidth=1.5, alpha=0.7, label='$x = \pi/4$')
...
aire = 2*np.sqrt(2) - 2
plt.text(0.02, 0.98, f'$A = 2\\sqrt{{2}} - 2 \\approx {aire:.3f}$', 
         transform=plt.gca().transAxes, fontsize=14, fontweight='bold',
         bbox=dict(boxstyle='round', facecolor='lightgreen', alpha=0.8),
         verticalalignment='top')

# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/aire_entre_courbes_question3.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'aire_entre_courbes_question3.png' créé avec succès!")
