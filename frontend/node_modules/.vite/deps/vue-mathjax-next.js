...
// node_modules/vue-mathjax-next/lib/index.js
var require_lib = __commonJS({
  "node_modules/vue-mathjax-next/lib/index.js"(exports, module) {
    var e = require_vue();
    var t = e.defineComponent({ name: "VueMathjax", props: { formula: { type: String, default: "" }, safe: { type: Boolean, default: true }, options: { type: Object, default: function() {
      return {};
    } } }, setup(t2) {
      const a2 = e.reactive({ mathjaxRef: null }), n = () => {
        t2.safe ? a2.mathjaxRef.textContent = t2.formula : a2.mathjaxRef.innerHTML = t2.formula, window.MathJax && (window.MathJax.Hub.Config({ tex2jax: { inlineMath: [["$", "$"], ["(", ")"]], displayMath: [["$$", "$$"], ["[", "]"]], processEscapes: true, processEnvironments: true }, displayAlign: "center", "HTML-CSS": { styles: { ".MathJax_Display": { margin: 0 } }, linebreaks: { automatic: true } }, ...t2.options }), window.MathJax.Hub.Queue(["Typeset", window.MathJax.Hub, a2.mathjaxRef]));
      };
      return e.watch(() => t2.formula, () => {
        n();
      }), e.onMounted(() => {
        n();
      }), { ...e.toRefs(a2) };
    } });
    var a = { ref: "mathjaxRef" };
    t.render = function(t2, n, o, r, i, s) {
      return e.openBlock(), e.createElementBlock("span", a, null, 512);
    }, t.__file = "src/index.vue", t.install = function(e2) {
      e2.component(t.name, t);
    }, module.exports = t;
  }
});
...
vue/dist/vue.cjs.js:
  ...
  **)
*/
//# sourceMappingURL=vue-mathjax-next.js.map
