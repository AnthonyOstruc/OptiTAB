...
# Courbes
plt.plot(x1, k(x1), 'b-', linewidth=2, label=r'$k(x) = \frac{e^x - 1}{x}$')
plt.plot(x2, k(x2), 'b-', linewidth=2)

# Trou en x = 0, y = 1 (discontinuité évitable)
plt.plot(0, 1, 'ro', markersize=8, markerfacecolor='white', markeredgewidth=2, label='Trou en $(0, 1)$')

# Point de prolongement
plt.plot(0, 1, 'go', markersize=6, label='Prolongement : $k(0) = 1$')

# Annotation
ax.annotate('$k(0) = 1$', (0, 1), xytext=(-5, 4), fontsize=10,
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/prolongement_question4.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'prolongement_question4.png' créé avec succès!")
