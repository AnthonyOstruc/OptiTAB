...
# Valeur moyenne
valeur_moyenne = 2/np.pi

# Intervalles
x1 = np.linspace(-20, 4, 1000)

# Courbes
plt.plot(x1, f(x1), 'b-', linewidth=2, label=r'$f(x) = \cos(x)$')

# Ligne de valeur moyenne
plt.axhline(y=valeur_moyenne, color='red', linestyle='--', linewidth=2, alpha=0.8, label=f'Valeur moyenne = {valeur_moyenne:.3f}')
...
plt.text(0.02, 0.98, f'$\\mu = \\frac{{2}}{{\\pi}} \\approx {valeur_moyenne:.3f}$', 
         transform=plt.gca().transAxes, fontsize=14, fontweight='bold',
         bbox=dict(boxstyle='round', facecolor='lightblue', alpha=0.8),
         verticalalignment='top')

# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/valeur_moyenne_question5.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'valeur_moyenne_question5.png' créé avec succès!")
