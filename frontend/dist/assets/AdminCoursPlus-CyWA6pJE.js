import{a as p,c as tt,e as et,b as d,aq as it,d as a,i as h,m as M,L as U,O as ot,F as k,s as T,t as g,B as rt,o as u,n as S,l as nt}from"./vendor-DmGtpD4U.js";import{_ as at}from"./index-Bz4XJAFk.js";import{a as lt,f as st}from"./curriculum-B8eYFYgx.js";import{g as dt,u as ut,a as gt,c as ct}from"./cours-ZXco5UcN.js";import{r as pt,a as ft}from"./scientificRenderer-B77YcBUU.js";import"./ui-jaH5oyHW.js";import"./pdf-S6SQ1w6P.js";import"./mathlive-B5k0jhbN.js";const mt={class:"bulk-form"},vt=["value"],ht={class:"images-upload-section"},xt={key:0,class:"selected-images"},bt=["src","alt"],qt={class:"image-name"},yt=["onClick"],It={class:"btn-group"},Ct=["disabled"],Et=["disabled"],_t={key:0,class:"success-msg"},$t={key:1,class:"error-msg"},At={key:2,class:"info-msg"},kt={key:3,class:"preview-section"},Tt={key:0,class:"preview-image-info"},Lt={class:"image-indicator"},Nt={class:"image-status-list"},Mt={class:"preview-cours"},Ot={class:"preview-header"},wt={class:"ordre-badge"},Dt={key:0,class:"preview-description"},Pt=["innerHTML"],Rt=10*1024*1024,Ut={__name:"AdminCoursPlus",setup(St){const j=["image/jpeg","image/jpg","image/png","image/gif","image/webp","image/svg+xml"],y=p([]),_=p([]),$=p(""),c=p(""),v=p(""),L=p(""),m=p(""),x=p([]),O=p(!1),b=p([]),N=p(null);class z{constructor(){this.images=new Map}addImage(e){if(!this.validateImage(e))throw new Error(`Image invalide: ${e.name}`);this.images.set(e.name,e)}removeImage(e){this.images.delete(e)}validateImage(e){return!(!j.includes(e.type)||e.size>Rt)}getImage(e){return this.images.get(e)}getImageNames(){return Array.from(this.images.keys())}}const I=new z;function w(i){return _.value.find(e=>String(e.id)===String(i))}function F(i){if(!i)return null;const e=w(i.notion);if(!e)return{themeNom:"",matiereNom:"",paysNom:"",niveauNom:""};const t=e.matiere_nom||e.contexte_detail&&e.contexte_detail.matiere_nom||"",n=e.theme_nom||"",r=e.contexte_detail&&e.contexte_detail.pays?e.contexte_detail.pays.nom:"",l=e.contexte_detail&&e.contexte_detail.niveau?e.contexte_detail.niveau.nom:"";return{matiereNom:t,themeNom:n,paysNom:r,niveauNom:l}}function D(i){const e=w(i.notion),t=F(i);return[i.nom,e?`— ${e.nom}`:"",t&&t.matiereNom?`— ${t.matiereNom}`:"",t&&(t.paysNom||t.niveauNom)?`— ${[t.paysNom,t.niveauNom].filter(Boolean).join(" · ")}`:""].filter(Boolean).join(" ")}function V(i){return{easy:"Facile",medium:"Moyen",hard:"Difficile"}[i]||i}function B(i){return URL.createObjectURL(i)}function A(i){return I.getImage(i)}function G(i,e=null){return(i||"").split(",").map(n=>n.trim()).filter(Boolean).map((n,r)=>{const l=A(n);return{id:`preview-${r}`,image:l?URL.createObjectURL(l):n,image_type:"illustration",position:r+1}})}function W(i){const e=G(i.image,i);let t=i.contenu;const n=(i.image||"").split(",").map(r=>r.trim()).filter(Boolean);if(t=t.replace(/\[IMAGE_(\d+)\]/g,(r,l)=>{const o=parseInt(l)-1,s=n[o],f=A(s);return f?`
...
`),t={titre:"",description:"",contenu:"",difficulty:"medium",ordre:0,image:"",chapitre:c.value,matiere:null,notion:null};if(c.value){const l=y.value.find(o=>o.id==c.value);if(l){const o=_.value.find(s=>s.id==l.notion);o&&(t.notion=o.id,t.matiere=o.matiere)}}let n="header",r=[];for(let l=0;l<e.length;l++){const o=e[l].trim();o&&(n==="header"?o.startsWith("Difficulté:")?t.difficulty=o.split(":")[1].trim():o.startsWith("Ordre:")?t.ordre=parseInt(o.split(":")[1].trim())||0:o.startsWith("Chapitre:")||(o.toLowerCase().startsWith("image:")||o.toLowerCase().startsWith("images:")?t.image=o.split(":")[1].trim():o.startsWith("Titre:")?t.titre=o.split(":")[1].trim():o.startsWith("Description:")?(t.description=o.split(":")[1].trim(),n="content"):!t.titre&&!o.startsWith("===")&&(t.titre=o)):r.push(o))}return t.contenu=r.join(`
`),!t.titre||!t.contenu||!t.matiere||!t.chapitre?null:t}function X(){try{O.value=!0,x.value=P(v.value),rt(()=>{pt()})}catch{m.value="Erreur lors de la prévisualisation"}}async function Y(){if(!c.value){m.value="Veuillez sélectionner un chapitre";return}const i=y.value.find(t=>t.id==c.value);if(!i){m.value="Chapitre invalide";return}if(!_.value.find(t=>t.id==i.notion)){m.value="Notion invalide pour ce chapitre";return}try{const t=P(v.value);if(t.length===0){m.value="Aucun cours valide trouvé";return}let n=0,r=0,l=0,o=null;try{const s=await dt(null,null,Number(c.value)),f=Array.isArray(s?.data)?s.data:Array.isArray(s)?s:[];f&&f.length>0&&(o=f[0].id)}catch{}for(const s of t)try{const f={chapitre:Number(s.chapitre),titre:s.titre,contenu:s.contenu,ordre:s.ordre||0,difficulty:s.difficulty||"medium"};let C;if(o)C=(await ut(o,f))?.id||o,r++;else{const{data:E}=await gt(f);C=E?.id,n++,o=C}if(s.image&&C){const E=s.image.split(",").map(q=>q.trim()).filter(Boolean);for(let q=0;q<E.length;q++){const R=I.getImage(E[q]);if(R){const K={cours:C,image:R,image_type:"illustration",position:q+1};await ct(K)}}}}catch{l++}if(n>0||r>0){L.value=`${n} créé(s)${r?`, ${r} mis à jour`:""}${l>0?`, ${l} erreur(s)`:""}`;const s=c.value;v.value="",x.value=[],b.value=[],I.images.clear(),N.value&&(N.value.value=""),c.value=s}else m.value="Aucun cours n'a pu être créé"}catch{m.value="Erreur lors de la création des cours"}}const Z=tt(()=>{if(!$.value)return y.value;const i=$.value.toLowerCase();return y.value.filter(e=>D(e).toLowerCase().includes(i))});return et(async()=>{try{const[i,e]=await Promise.all([lt(),st()]);y.value=Array.isArray(i)?i:i?.data||[],_.value=Array.isArray(e)?e:e?.data||[]}catch{}}),(i,e)=>(u(),d("div",null,[e[8]||(e[8]=it(`<h2 class="admin-title" data-v-d4fcef03>Bulk – Ajout de Cours</h2><div class="format-help" data-v-d4fcef03><h3 data-v-d4fcef03>📋 Format requis :</h3><div class="format-example" data-v-d4fcef03><pre data-v-d4fcef03><code data-v-d4fcef03>=== [NOM DU COURS - SOUS-TITRE]
