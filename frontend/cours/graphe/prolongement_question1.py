...
# Courbes
plt.plot(x1, f(x1), 'b-', linewidth=2, label=r'$f(x) = \frac{x^3 - 8}{x - 2}$')
plt.plot(x2, f(x2), 'b-', linewidth=2)

# Trou en x = 2, y = 12 (discontinuité évitable)
plt.plot(2, 12, 'ro', markersize=8, markerfacecolor='white', markeredgewidth=2, label='Trou en $(2, 12)$')

# Point de prolongement
plt.plot(2, 12, 'go', markersize=6, label='Prolongement : $f(2) = 12$')

# Annotation (déplacée pour éviter l'axe)
ax.annotate('$f(2) = 12$', (2, 12), xytext=(5, 15), fontsize=10,
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/prolongement_question1.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'prolongement_question1.png' créé avec succès!")
