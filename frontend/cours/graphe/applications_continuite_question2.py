...
# Courbe
plt.plot(x, f(x), 'b-', linewidth=2, label=r'$f(x) = x^5 - 5x + 1$')
...
ax.annotate('$f(-1) = 5$', (-1, f(-1)), xytext=(-6, 8), fontsize=10,
            arrowprops=dict(arrowstyle='->', color='red', lw=1))

plt.plot(1, f(1), 'ro', markersize=6)
ax.annotate('$f(1) = -3$', (1, f(1)), xytext=(4, -6), fontsize=10,
            arrowprops=dict(arrowstyle='->', color='red', lw=1))
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/applications_continuite_question2.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'applications_continuite_question2.png' créé avec succès!")
