...
# Courbe
plt.plot(x, g(x), 'b-', linewidth=2, label=r'$g(x) = xe^x$')

# Tangente au point x = 0
plt.plot(x, tangente(x), 'r--', linewidth=2, label='Tangente en $x = 0$ : $y = x$')

# Point de contact
plt.plot(0, 0, 'go', markersize=6, label='Point de contact $(0, 0)$')

# Annotation pour la tangente
ax.annotate('Tangente: $y = x$', (2, 2), xytext=(10, 10), fontsize=10,
...
# Sauvegarde
plt.savefig('exercice_exponentielle_derivee_question5.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'exercice_exponentielle_derivee_question5.png' créé avec succès!")
