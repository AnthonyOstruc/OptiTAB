...
x1 = np.linspace(-20, -0.1, 1500)
x2 = np.linspace(0.1, 20, 1500)

# Courbes
plt.plot(x1, h(x1), 'b-', linewidth=2, label=r'$h(x) = \frac{1}{x^2}$')
plt.plot(x2, h(x2), 'b-', linewidth=2)

# Asymptote verticale x = 0
plt.axvline(x=0, color='red', linestyle='--', linewidth=1.5, alpha=0.7, label='Asymptote verticale $x = 0$')

# Asymptote horizontale y = 0
plt.axhline(y=0, color='green', linestyle='--', linewidth=1.5, alpha=0.7, label='Asymptote horizontale $y = 0$')
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/discontinuites_question3.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'discontinuites_question3.png' créé avec succès!")
