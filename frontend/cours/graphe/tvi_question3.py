...
x1 = np.linspace(0.05, 20, 1500)
x2 = np.linspace(-20, 20, 1500)

# Courbes
plt.plot(x1, f1(x1), 'b-', linewidth=2, label=r'$y = \ln x$')
plt.plot(x2, f2(x2), 'r-', linewidth=2, label=r'$y = 1 - x$')

# Point d'intersection en x = 1
plt.plot(1, 0, 'go', markersize=8, label='Solution en $(1, 0)$')
ax.annotate('$x = 1$ (solution)', (1, 0), xytext=(5, 3), fontsize=10,
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/tvi_question3.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'tvi_question3.png' créé avec succès!")
