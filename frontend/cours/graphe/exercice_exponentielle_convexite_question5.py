...
# Asymptotes limites y -> 0 aux extrémités (représentation visuelle)
plt.axhline(y=0, color='red', linestyle='--', linewidth=2, label='Limite $y = 0$ en $\pm\infty$')
...
# Sauvegarde
plt.savefig('exercice_exponentielle_convexite_question5.png', dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'exercice_exponentielle_convexite_question5.png' créé avec succès!")
