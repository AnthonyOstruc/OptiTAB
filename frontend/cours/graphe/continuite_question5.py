...
# Courbe
plt.plot(x, m(x), 'b-', linewidth=2, label=r'$m(x) = |x - 3|$')

# Point en x = 3, y = 0 (continue)
plt.plot(3, 0, 'go', markersize=8, label='Continue en $(3, 0)$')

# Annotation (déplacée bien à droite)
ax.annotate('$m(3) = 0$', (3, 0), xytext=(8, 4), fontsize=10,
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/continuite_question5.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'continuite_question5.png' créé avec succès!")
