...
# Courbes
plt.plot(x1, k(x1), 'b-', linewidth=2, label=r'$k(x) = \sin\left(\frac{1}{x}\right)$')
plt.plot(x2, k(x2), 'b-', linewidth=2)

# Point défini en x = 0, y = 0
plt.plot(0, 0, 'ro', markersize=8, label='$k(0) = 0$ (oscillations)')

# Annotation
ax.annotate('Discontinuité essentielle', (0, 0), xytext=(5, 5), fontsize=10,
...
# Sauvegarde
plt.savefig('/Users/anthonytabet/Desktop/OptiTABV2/OptiTAB/frontend/cours/graphe/discontinuites_question4.png', 
            dpi=300, bbox_inches='tight')
plt.show()

print("Graphique 'discontinuites_question4.png' créé avec succès!")
